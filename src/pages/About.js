...
const About = () => {
  return (
    <>
      ...
      <h1>About Me</h1>
      <img
        src="http://www.themarketingsage.com/wp-content/uploads/2015/08/about-me-leon-severan-we-buy-houses.jpg"
        width="400"
        height={300}
        alt="aboutme"
      />
      <p>
        Welcome to my blog! Proin congue Lorem ipsum dolor sit amet, consectetur
